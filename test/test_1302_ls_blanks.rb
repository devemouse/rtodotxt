...
class Test1302_ls_blanks < Test::Unit::TestCase
...
"
   ...
   def test_ls_blanks_if_less_than_10_lines
      _tasks = [
   ...
   def test_ls_blanks_if_more_than_10_lines
      @tasks = [
                 'hex00 this is one line',
                 '',
                 'hex02 this is another line',
   ...
   def test_ls_many_blanks_if_more_than_10_lines
      @tasks = [
                 'hex00 this is one line',
                 '',
                 'hex02 this is another line',
